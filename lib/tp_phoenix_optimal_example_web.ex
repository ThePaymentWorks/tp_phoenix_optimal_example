defmodule TpPhoenixOptimalExampleWeb do
  @moduledoc """
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: TpPhoenixOptimalExampleWeb
      import Plug.Conn
  ...
  def view do
    quote do
      use Phoenix.View, root: "lib/tp_phoenix_optimal_example_web/templates",
                        namespace: TpPhoenixOptimalExampleWeb
